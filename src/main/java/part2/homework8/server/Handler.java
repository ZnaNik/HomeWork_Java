...
import part2.homework8.common.enums.Command;
import part2.homework8.server.error.NickAlreadyIsBusyException;
import part2.homework8.server.error.WrongCredentialsException;
...
public class Handler {
    ...
    //Логически принимаем, что можно дисконектить юзеров у которых нет ника
    //потому что успешное условие авторизации = присваеваемому нику
}
