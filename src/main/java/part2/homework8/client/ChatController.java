package part2.homework8.client;
...
import part2.homework8.client.net.MessageProcessor;
import part2.homework8.client.net.NetworkService;
import part2.homework8.common.enums.*;
...
public class ChatController implements Initializable, MessageProcessor {
    ...
    private void parseMessage(String message) {
        ...
        switch (command) {
            ...
            case NOT_AUTHORISED -> showError("Server disconnected u");
