...
public class GameClass {
    ...
    private Human human;
    private homework4.game.turns.Ai ai;
    ...
    private void initiateRules() {
        ...
        if (minInARowWin == field.size_field)
            ...
            if (ConstsClass.debug)
                ...
                winCountInALine = homework4.consts.UtilsClass.getCorrectNumber(minInARowWin, field.size_field);
            }
